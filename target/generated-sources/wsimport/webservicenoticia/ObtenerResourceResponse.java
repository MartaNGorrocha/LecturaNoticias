    ...
    implements Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObtenerResourceResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObtenerResourceResponse that = ((ObtenerResourceResponse) object);
        {
            JAXBElement<String> lhsReturn;
            lhsReturn = this.getReturn();
            JAXBElement<String> rhsReturn;
