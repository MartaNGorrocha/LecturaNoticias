    ...
    implements Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AutenticarResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AutenticarResponse that = ((AutenticarResponse) object);
        {
            Boolean lhsReturn;
            lhsReturn = this.isReturn();
            Boolean rhsReturn;
            rhsReturn = that.isReturn();
